...
int p0(void)
{
	...
	while(page == 0)
	{
		...
		if(mouse_press(40,400,200,440) == 1)      //点击注册按钮
		{
			page = 1;
		}
		else if(mouse_press(440,400,600,440) == 1)        //点击退出按钮
		{
			page = 3;
		}
		else if(mouse_press(240,400,400,440) == 1)			//点击登录按钮
		{
			page = 2;
		}
		else if(mouse_press(40,400,200,440) == 2)
		{
			if(num == 0)               //防止反复标亮
			{
				...
				puthz(80,404,"注册",32,40,DARKGRAY);
				num = 1;
			} 
			continue;
		}
		else if(mouse_press(440,400,600,440) == 2)
		{
			if(num == 0)               
			{
				...
				puthz(480,404,"退出",32,40,DARKGRAY);
				num = 2;
			} 
			continue;
		}
		else if(mouse_press(240,400,400,440) == 2)
		{
			if(num == 0)               
			{
				...
				puthz(280,404,"登录",32,40,DARKGRAY);
				num = 3;
			} 
			continue;
		}
